...
function App() {
  ...
  const [counterHome, setCountHome] = useState(0);
  const [counterAway, setCountAway] = useState(0);
  // const [homeScore, setHomeScore] = useState(0);
  // const [awayScore, setAwayScore] = useState(0);

  const touchDownHome = () => {
    setCountHome(counterHome + 7);
  };

  const fieldGoalHome = () => {
    setCountHome(counterHome + 3);
  };

  const touchDownAway = () => {
    setCountAway(counterAway + 7);
  };

  const fieldGoalAway = () => {
    setCountAway(counterAway + 3);
  };
      ...
      <section className="scoreboard">
        <div className="topRow">
          <div className="home">
            ...
            <div className="home__score">{counterHome}</div>
          </div>
          <div className="timer">00:03</div>
          <div className="away">
            <h2 className="away__name">Tigers</h2>
            <div className="away__score">{counterAway}</div>
          </div>
        </div>
        <BottomRow />
      </section>
